...
Når man våkner som trollmann får man tilgang til en dyp kraft, dette skaper skjoldet. Man får også forståelse for hvordan fostre bomber. Disse trenger en tilknytning til kroppen. Det er vanlig å ofre fingrene på en av hendene sine. Man kan så fostre SUB’s knyttet til nervene for hver finger, på den måten kan man ha fem SUB’s på én gang.



Når man slåss fyrer man av én og én SUB, flere på en gang går ikke da de ville inteferert med hverandre. Disse flyr usynlig gjennom Otherverse mot den andre trollmannen. Hvis man treffer gjør de skade basert på SUB’ens farlighet, samt matching av frekvens mellom SUB og skjold.



Man slåss som regel inntil man er tom for SUB’s eller den andre siden er død. Når flere trollmenn er i nærheten av hverandre blir det et politisk spill. Den første som slåss kan potensielt åpne seg for angrep, ettersom man etter kampen ikke vil ha SUB’s på en liten stund. Det kan også muligens skapes allianser mellom trollmenn som midlertidig jobber sammen mot andre.



Styrke på SUB er normalfordelt rundt 50. Frekvensen til Skjold og SUB er fra 0 til 360. 180 mot 360 gir 0% skade, 360 mot 360 gir 100% skade.
...
- Hver gang man slåss mot noen finner man ut litt mer om frekvensen til skjoldet dems. Etter første kamp vet man at den er innenfor 180 grader, andre kamp 90, tredje 45, etc.

- Kanskje det er slik at hver kamp består av inntil fem rundre (én pr SUB). Hver spiller velger en SUB og skyter, så ser man resultatet på seg selv, og velger om man skyter en til eller trekker seg tilbake. Usikker på om det er nok at én trekker seg tilbake eller om begge to må gjøre det. Kanskje det å trekke seg tilbake gjør at man er litt mer vanskelig å treffe.
